...
class EventTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $e1 = [
            ...
            'club_id' => 1,
            'category_id' => 2 ,
            'opening_date' => Carbon::createFromDate(2018, 11,12),
            'opening' => Carbon::parse('11 p.m'),
            'closing_date' => Carbon::createFromDate(2018, 11,13),
        ...
        $e2 = [
            ...
            'club_id' => 2,
            'category_id' => 1 ,
            'opening_date' => Carbon::createFromDate(2018,11,11),
            'opening' => Carbon::parse('11 p.m'),
            'closing_date' => Carbon::createFromDate(2018, 11,12),
        ...
        $e3 = [
            ...
            'club_id' => 2,
            'category_id' => 2 ,
            'opening_date' => Carbon::createFromDate(2018,11,13),
            'opening' => Carbon::parse('10 pm'),
            'closing_date' => Carbon::createFromDate(2018, 11,14),
